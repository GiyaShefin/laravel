                        ...
                        <table class="table">
                            ...
                            @foreach($contacts as $item)
                                <tr>
                                    ...
                                    <td><a href="{{ url('/download',$item->document) }}">Download</a></td>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/user9-128.jpeg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Giya Shefin</a>
        </div>
      </div>
